  ...
  return (
    <div style={{ flexGrow: 1, overflowY: 'auto', padding: '20px', display: 'flex', flexDirection: 'column', gap: '15px' }}>
      ...
      <style>{`
        ...
        .typing-dot { width: 8px; height: 8px; background-color: ${currentTheme.text}; border-radius: 50%; margin-left: 5px; animation: bounce 1.4s infinite ease-in-out both; }
        .typing-dot:nth-child(2) { animation-delay: -0.32s; } .typing-dot:nth-child(3) { animation-delay: -0.16s; }
